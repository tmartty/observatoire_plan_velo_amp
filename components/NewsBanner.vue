<template>
  <div
    class="relative isolate flex items-center gap-x-6 overflow-hidden bg-cvv-blue-100 px-6 py-2.5 sm:px-3.5 sm:before:flex-1"
  >
    <div
    ...
    <div class="flex flex-wrap items-center gap-x-4 gap-y-2">
      ...
      <NuxtLink to="/historique" class="flex-none text-cvv-blue-600 py-1 text-sm font-semibold hover:underline">
