    ...
    <div class="relative max-w-7xl mx-auto">
      ...
      <div class="mt-4">
        ...
        <div class="mt-1 relative rounded-md shadow-sm">
          ...
          <input
            ...
            v-model="searchText"
            type="text"
            class="py-4 pl-10 pr-4 text-lg shadow-md focus:ring-cvv-blue-600 focus:border-cvv-blue-600 block w-full border-gray-900 text-gray-900 rounded-md"
      ...
      <div class="mt-4 max-w-7xl mx-auto grid gap-5 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:max-w-none">
        <NuxtLink
          ...
          :key="counter.name"
          :to="counter._path"
          class="flex flex-col rounded-lg shadow-md hover:shadow-lg overflow-hidden"
        >
          <div class="relative bg-cvv-blue-100">
            ...
            <div class="px-4 py-4 flex flex-col">
              <div class="text-base font-medium text-cvv-blue-600">
...
function getCounterLastRecordPreviousYear(counter) {
  ...
  const lastRecordMonthPreviousYearCount = counter.counts.find(
    count => new Date(count.month).getTime() === lastRecordMonthPreviousYear.getTime()
  )?.count;
  return {
